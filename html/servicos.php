...
<section id="planos" class="py-5">
    <div class="container">
        ...
        <div class="row g-4">
            <!-- Plano Básico -->
            <div class="col-md-4">
                <div class="card h-100 border-primary border-2 plano-card">
                    ...
                    <div class="card-body text-center">
                        ...
                        <ul class="list-unstyled mt-3 mb-4">
                            <li class="mb-2"><i class="fas fa-check text-primary me-2"></i>Site institucional</li>
                            <li class="mb-2"><i class="fas fa-check text-primary me-2"></i>Gerador de planos básicos</li>
                            <li class="mb-2"><i class="fas fa-check text-primary me-2"></i>Suporte técnico básico</li>
                            <li class="mb-2"><i class="fas fa-check text-primary me-2"></i>Até 50 alunos</li>
                        </ul>
                    </div>
                    <div class="card-footer bg-transparent border-0 text-center pb-4">
                        <a href="#contato" class="btn btn-outline-primary w-100">Escolher Plano</a>
                    </div>
                </div>
            </div>
            ...
            <!-- Plano Avançado -->
            <div class="col-md-4">
                <div class="card h-100 border-warning border-2 plano-card">
                    ...
                    <div class="card-body text-center">
                        ...
                        <ul class="list-unstyled mt-3 mb-4">
                            <li class="mb-2"><i class="fas fa-check text-warning me-2"></i>Site totalmente customizado</li>
                            <li class="mb-2"><i class="fas fa-check text-warning me-2"></i>Gerador avançado de planos</li>
                            <li class="mb-2"><i class="fas fa-check text-warning me-2"></i>Suporte premium 24/7</li>
                            <li class="mb-2"><i class="fas fa-check text-warning me-2"></i>Alunos ilimitados</li>
                            <li class="mb-2"><i class="fas fa-check text-warning me-2"></i>Relatórios avançados</li>
                            <li class="mb-2"><i class="fas fa-check text-warning me-2"></i>Integração com apps</li>
                        </ul>
                    </div>
                    <div class="card-footer bg-transparent border-0 text-center pb-4">
                        <a href="#contato" class="btn btn-outline-warning w-100">Escolher Plano</a>
                    </div>
                </div>
            </div>
        </div>
